...
def process_connected_stations_(cross, stations, directions, lengths):
...
def generate_way_command_(address):
...
def process_cross_(cross, paths, crosses, stations):
...
def main_(stations_data, crosses_data):
...
def process_cross(cross, shortest_paths, stations, crosses):
    ...
    log.info("Connected stations: %s", connected_stations)
...
def process(stations_data, crosses_data):
    ...
    crosses_commands = dict()
    for str_id, cross in crosses.items():
        crosses_commands[str_id] = process_cross(cross, shortest_paths, stations, crosses)
    log.info("Done processing crosses")
